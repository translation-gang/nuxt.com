const kapa = {
  ...
  'data-modal-disclaimer': 'Это кастомная LLM для ответов на вопросы о Nuxt. Ответы основаны на документации, информации с GitHub и статьях Stack Overflow. Ответы генерируются ИИ и могут быть неточными — используйте собственное суждение.',
