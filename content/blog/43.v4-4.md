...
Внутри за это отвечает новый специализированный (ad hoc) модуль Nuxt: он сканирует папку composables и регистрирует ваши экземпляры для инъекции по ключу, поэтому они работают с SSR так же, как `useAsyncData` и `useFetch`.
