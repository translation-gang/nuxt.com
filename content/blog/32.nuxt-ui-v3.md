...
Подготовлено [руководство по миграции](https://ui.nuxt.com/getting-started/migration) с v2 на v3. Из-за полного переписывания есть несовместимые изменения, но мы постарались сделать переход максимально плавным.
