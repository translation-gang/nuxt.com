...
head.title: Набор для дизайна Nuxt
head.description: Получите ассеты Nuxt — логотип, типографику и цвета.
...
Для машиночитаемых дизайн-токенов (цвета, типографика, отступы, компоненты) см. [/design.md](/design.md).
