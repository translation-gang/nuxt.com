...
2. Во время развёртывания настройте переменные окружения в панели Zeabur. На странице службы откройте вкладку переменных и задайте [переменные окружения](https://zeabur.com/docs/deploy/variables):
    ```bash
