...
const displayTitle = computed(() => props.title || 'Без названия')
...
const items = computed<DropdownMenuItem[][]>(() => [[
  { label: 'Переименовать', icon: 'i-lucide-pencil', onSelect: rename }
], [
  { label: 'Удалить', icon: 'i-lucide-trash', color: 'error' as const, onSelect: () => deleteChat(props.chatId) }
]])
</script>
