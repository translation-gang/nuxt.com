...
const VERBS: Record<string, [string, string]> = {
  list: ['Поиск', 'Найдено'],
  search: ['Поиск', 'Найдено'],
  find: ['Поиск', 'Найдено'],
  query: ['Поиск', 'Найдено'],
  get: ['Чтение', 'Прочитано'],
  read: ['Чтение', 'Прочитано'],
  fetch: ['Чтение', 'Прочитано'],
  show: ['Поиск', 'Найдено'],
  open: ['Открытие', 'Открыто'],
  generate: ['Генерация', 'Сгенерировано'],
  create: ['Создание', 'Создано']
}
...
export function getConnectionSearchToolText(part: ToolPart): string {
  return isToolStreaming(part) ? 'Поиск инструментов подключения...' : 'Инструменты подключения найдены'
}
...
const RICH_TOOL_HEADERS = {
  show_module: { loading: 'Загрузка модуля...', success: 'Модуль найден', error: 'Модуль не найден', icon: 'i-lucide-box' },
  show_template: { loading: 'Загрузка шаблонов...', success: 'Шаблоны найдены', error: 'Шаблоны не найдены', icon: 'i-lucide-layout-template' },
  show_blog_post: { loading: 'Поиск поста...', success: 'Пост найден', error: 'Пост не найден', icon: 'i-lucide-newspaper' },
  show_hosting: { loading: 'Загрузка провайдера...', success: 'Провайдер найден', error: 'Провайдер не найден', icon: 'i-lucide-server' },
  open_playground: { loading: 'Генерация playground...', success: 'Playground готов', error: 'Playground готов', icon: 'i-simple-icons-stackblitz' },
  report_issue: { loading: 'Подготовка формы отзыва...', success: 'Помогите нам стать лучше', error: 'Помогите нам стать лучше', icon: 'i-lucide-message-circle-warning' },
  show_prompt: { loading: 'Подготовка промпта...', success: 'Готово к применению', error: 'Промпт недоступен', icon: 'i-lucide-sparkles' }
...
export function getToolText(part: ToolPart) {
  ...
  return `${done ? 'Найдено' : 'Поиск'} ${label}`
}
